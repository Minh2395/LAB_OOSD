...
namespace QuanLyThuVien.Forms
{
    public partial class FrmMuonTra : Form
    {
        ...
        {
            KetQuaXuLy kq = service.KiemTraDieuKienMuon(
                MaDocGiaMuon,
                Math.Max(1, selectedBooks.Rows.Count));

            lblTrangThai.Text = kq.ThongBao;

            lblTrangThai.ForeColor = kq.ThanhCong
        ...
        private void TaiSachDangMuon()
        {
            ...
            dgvDangMuon.DataSource =
                service.LaySachDangMuon(MaDocGiaTra);
